...
/**
 * @author Hasee  2021/3/19 18:43 周五
 * @version JDK 8.017
 * @description:
 */
@Component
    ...
    public void listener(Long spuId, Channel channel, Message message) throws IOException {
        ...
        if (!CollectionUtils.isEmpty(skuEntities)) {
            ...
            this.goodsRepository.saveAll(skuEntities.stream().map(skuEntity -> {
                ...
                // 2.查询基本类型的检索属性
                ResponseVo<List<SpuAttrValueEntity>> spuAttrValueResponseVo = this.pmsClient.querySearchAttrValuesBySpuId(spuEntity.getCategoryId(), spuEntity.getId());
